...
houses %>%
  ...
  broom::tidy()
#'this has a tiny p value and so is significent there is an increse in price by .18 for each bedroom added
...
#' for each increese in bedrooms there is a almost 3% incresss in price
#' # 3. Multicollinearity
#'
...
#' with?
#' mainroad, hotwaterheating, prefarea
...
#' the third solution seems the best as it is easyer to remove data then gather more 
